...
<table class="table" >
<tr class="success">
	<td colspan="2" align="center">RULE GEJALA DAN PENYAKIT KULIT</td>
</tr>
<tr>
	<td colspan="2"><b>Nama Penyakit Dan Solusi: </b></td>
</tr>
<tr>
	<td colspan="2">
	<select name="CmbSolusi" >
	<option value=0> Daftar Penyakit Dan Solusi </option>
	<?php
